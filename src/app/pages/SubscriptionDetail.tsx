          ...
          {isEditing ? (
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {/* Login method detection — show based on email domain */}
                <div>
                  <p className="text-xs text-muted-foreground mb-1">Login Method</p>
                  <div className="flex items-center gap-2">
                    {subscription.email.includes('@gmail') && (
                    ...
                    {(subscription.email.includes('github') || subscription.email.includes('@users.noreply.github')) && (
                    ...
                    {(subscription.email.includes('@outlook') || subscription.email.includes('@hotmail') || subscription.email.includes('@live')) && (
                    ...
                    {(subscription.email.includes('@icloud') || subscription.email.includes('@me.com') || subscription.email.includes('@mac.com')) && (
                      <Badge variant="outline" className="flex items-center gap-1.5 rounded-full bg-slate-500/10 border-slate-500/30 text-slate-400">
                        Apple
                      </Badge>
                    )}
                    ...
                    {!subscription.email.includes('@gmail') &&
                     !subscription.email.includes('github') &&
                     !subscription.email.includes('@outlook') &&
                     !subscription.email.includes('@hotmail') &&
                     !subscription.email.includes('@live') &&
                     !subscription.email.includes('@icloud') &&
                     !subscription.email.includes('@me.com') &&
                     !subscription.email.includes('@mac.com') && (
